...
export const FAQ: FAQEntry[] = [
  ...
  },
  {
    ...
    keywords: [
      "профилактика", "обслужване", "поддръжка", "почистване",
      "сервис", "обслуживание", "чистка", "профилактика",
      "сервіс", "обслуговування", "чистка", "профілактика",
      "service", "maintenance", "cleaning", "refill", "freon", "фреон",
    ],
    q: {
