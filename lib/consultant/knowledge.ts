...
export const FAQ: FAQEntry[] = [
  {
    ...
    a: {
      ...
      ru: "До 5 лет гарантии — полная гарантия производителя (Daikin, Mitsubishi, Gree и др.) при монтаже нашей бригадой в Варне. Плюс 12 месяцев гарантии на сам монтаж. Гарантийное обслуживание — на месте.",
  ...
  },
  {
    ...
    a: {
      bg: "Да — предлагаме пълно обслужване след монтажа: 1) Годишна профилактика — пълно почистване на вътрешно и външно тяло, проверка на фреон, дезинфекция. От 82 лв. (≈ 42 €). 2) Ремонт и диагностика (всички марки) — диагностика 40 лв., търсене на течове, смяна на компресор/платки, зареждане с R-32 / R-410A. Правилната профилактика веднъж годишно удължава живота на климатика с години.",
      en: "Yes — full post-install service: 1) Annual maintenance — full cleaning of indoor and outdoor units, freon check, disinfection. From 82 BGN (≈ 42 €). 2) Repair and diagnostics (all brands) — diagnostics 40 BGN, leak detection, compressor/board replacement, R-32 / R-410A refill. Annual maintenance extends unit life by years.",
      ru: "Да — полный сервис после монтажа: 1) Годовая профилактика — полная чистка внутреннего и внешнего блока, проверка фреона, дезинфекция. От 82 лв. (≈ 42 €). 2) Ремонт и диагностика (все марки) — диагностика 40 лв., поиск утечек, замена компрессора/плат, заправка R-32 / R-410A. Регулярная профилактика продлевает срок службы на годы.",
      ua: "Так — повний сервіс після монтажу: 1) Річна профілактика — повне чищення внутрішнього і зовнішнього блоку, перевірка фреону, дезінфекція. Від 82 лв. (≈ 42 €). 2) Ремонт і діагностика (усі марки) — діагностика 40 лв., пошук витоків, заміна компресора/плат, заправка R-32 / R-410A. Регулярна профілактика подовжує термін служби на роки.",
    },
  },
  {
