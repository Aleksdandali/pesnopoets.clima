...
export const howToChooseAc: BlogPost = {
  ...
  faq: {
    bg: [
      ...
      { question: "Колко струва монтажът на климатик?", answer: "Стандартният монтаж (до 3 м тръбопровод) започва от 372 лв. Цената зависи от етажа, дължината на тръбопровода и сложността на монтажа. Не пестете от монтажа — лошият монтаж анулира гаранцията и увеличава сметката за ток." },
    ],
    en: [
      ...
      { question: "How much does AC installation cost?", answer: "Standard installation (up to 3 m piping) starts from 372 BGN (~190 EUR). Price depends on floor level, pipe length, and complexity. Never skimp on installation — poor work voids warranty and increases electricity bills." },
    ],
    ru: [
      ...
      { question: "Сколько стоит монтаж кондиционера?", answer: "Стандартный монтаж (до 3 м трассы) — от 372 лв (~190 евро). Цена зависит от этажа, длины трассы и сложности. Не экономьте на монтаже — плохая установка аннулирует гарантию и увеличивает счет за электричество." },
    ],
    ua: [
      ...
      { question: "Скільки коштує монтаж кондиціонера?", answer: "Стандартний монтаж (до 3 м траси) — від 372 лв (~190 євро, ~5300 грн). Ціна залежить від поверху, довжини траси та складності. Не економте на монтажі — поганий монтаж анулює гарантію і збільшує рахунок за електрику." },
    ],
  },
};
