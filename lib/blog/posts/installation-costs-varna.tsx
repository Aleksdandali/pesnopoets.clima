  ...
  return (
    <>
      ...
      <ul>
        ...
        <li>
          <a href="/bg/profilaktika"><strong>Профилактика и почистване</strong></a> — годишна поддръжка от 42 €, удължава живота на климатика с години.
        </li>
      </ul>
    </>
  );
  ...
  return (
    <>
      ...
      <ul>
        ...
        <li>
          <a href="/ru/profilaktika"><strong>Профилактика и чистка</strong></a> — ежегодное обслуживание от 42 €, продлевает срок службы кондиционера на годы.
        </li>
      </ul>
    </>
  );
  ...
  return (
    <>
      ...
      <ul>
        ...
        <li>
          <a href="/ua/profilaktika"><strong>Профілактика та чищення</strong></a> — щорічне обслуговування від 42 €, продовжує термін служби кондиціонера на роки.
        </li>
      </ul>
    </>
  );
