...
function ContentRU() {
  return (
    <>
      ...
      <p>
        В этой статье — конкретные цифры: какая температура для лета в Варне,
      ...
      <h2>Идеальная температура летом в Варне</h2>
      <p>
...
export const acCorrectSettingsGuide: BlogPost = {
  ...
  excerpt: {
    ...
    ru: "Конкретные температуры лета и зимы в Варне, когда использовать Dry, Sleep, Eco, Turbo и 7 самых частых ошибок пользователей. Экономия до 35% счёта.",
  ...
  faq: {
    ...
    ru: [
      ...
      { question: "Сколько стоит держать кондиционер на 22°C всё лето?", answer: "На 40% больше, чем 26°C. Для типичной квартиры в Варне с 12000 BTU это 60-90 лв доплаты в месяц. Рекомендуется: 25-26°C + Sleep mode ночью." },
