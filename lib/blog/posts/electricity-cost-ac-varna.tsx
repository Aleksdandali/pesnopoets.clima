...
function ContentRU() {
  return (
    <>
      ...
      <p>
        Для типичной квартиры в Варне с инверторным кондиционером 12000 BTU
      ...
      <ul>
        ...
        <li><strong>Цена тока</strong> — в Варне для бытовых клиентов ~0.22-0.30 лв/kWh дневной, ~0.13-0.18 лв/kWh ночной (свободный рынок с 2025 г. — реальные цены зависят от вашего поставщика).</li>
      </ul>
      ...
      <h2>Тарифы тока в Варне (2026)</h2>
      <p>
      ...
      <p>
        Для типичной квартиры в Варне годовая разница инвертор vs неинвертор:
      </p>
      <ul>
...
export const electricityCostAcVarna: BlogPost = {
  ...
  title: {
    ...
    ru: "Сколько электричества потребляет кондиционер в Варне — реальные цены, формула и как срезать 40%",
  ...
  faq: {
    ...
    ru: [
      { question: "Сколько стоит ток для кондиционера 12000 BTU в месяц в Варне?", answer: "Для инвертора А++ при 8 часах ежедневно — около 70 лв в месяц. При 12 часах — около 105 лв. Sleep mode ночью снижает расход на 30-40%." },
