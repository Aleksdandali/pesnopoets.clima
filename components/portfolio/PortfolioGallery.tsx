...
const PHOTOS: Photo[] = [
  {
    ...
    alt: {
      ...
      ru: "Завершённый монтаж кондиционера на стене с деревянными рейками в Варне",
  ...
  },
  {
    ...
    alt: {
      ...
      ru: "Монтаж внешнего блока на балконе с видом в Варненской области",
  ...
  },
  {
    ...
    alt: {
      ...
      ru: "Завершённый монтаж кондиционера Gree на белой стене в квартире в Варне",
  ...
  },
  {
    ...
    alt: {
      ...
      ru: "Подготовка к монтажу кондиционера в квартире в Варне",
  ...
  },
  {
    ...
    alt: {
      ...
      ru: "Мастер устанавливает внешний блок кондиционера с видом на горы в Варненской области",
