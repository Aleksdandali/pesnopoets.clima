...
const COPY: Record<Locale, PromoCopy> = {
  bg: {
    ...
    subheadline:
      "Промоция до 31 май: спестявате около €140 от обикновената цена на монтажа. Само за първите 20 заявки от Telegram групи на Варна.",
    ...
    formTitle: "Заяви монтаж за €50",
    formSubtitle: "Свързваме се с теб в рамките на 30 минути.",
    formName: "Име",
    formPhone: "Телефон",
    formMessage: "Бележка (по желание)",
    formMessagePlaceholder: "Например: климатик за стая 20 m², 5-ти етаж",
    formCodeLabel: "Промокодът ще се запише автоматично:",
  ...
  en: {
    ...
    subheadline:
      "Until May 31: save around €140 off standard install pricing. Only for the first 20 requests from Varna Telegram groups.",
    ...
    formCodeLabel: "Promo code (auto-applied):",
  ...
  ru: {
    ...
    subheadline:
      "Акция до 31 мая: экономия около €140 от обычной цены монтажа. Только для первых 20 заявок из Telegram групп Варны.",
    ...
    formTitle: "Заявить монтаж за €50",
    ...
    formCodeLabel: "Промокод (применится автоматически):",
  ...
  ua: {
    ...
    subheadline:
      "Акція до 31 травня: економія близько €140 від звичайної ціни монтажу. Лише для перших 20 заявок з Telegram груп Варни.",
    ...
    formCodeLabel: "Промокод (застосується автоматично):",
