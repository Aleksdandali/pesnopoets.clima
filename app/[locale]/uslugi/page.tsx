...
const uslugiFaq: Record<string, { q: string; a: string }[]> = {
  bg: [
    { q: "Колко струва профилактиката на климатик?", a: "Годишната профилактика започва от 82 лв. на уред. Включва почистване на филтри и топлообменник, проверка на дренажа, налягането на фреона и тест на производителността." },
  ...
  en: [
    { q: "How much does AC maintenance cost?", a: "Annual maintenance starts from 82 BGN per unit. It includes filter and coil cleaning, drainage check, refrigerant pressure check, and performance testing." },
  ...
  ru: [
    { q: "Сколько стоит обслуживание кондиционера?", a: "Ежегодное обслуживание (профилактика) — от 82 лв. за блок. Включает чистку фильтров и теплообменника, проверку дренажа, давления фреона и тест производительности." },
  ...
  ua: [
    { q: "Скільки коштує обслуговування кондиціонера?", a: "Щорічне обслуговування (профілактика) — від 82 лв. за блок. Включає чистку фільтрів і теплообмінника, перевірку дренажу, тиску фреону та тест продуктивності." },
