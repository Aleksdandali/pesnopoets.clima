...
const sectionLabels: Record<string, {
  ...
  bg: {
    ...
    brands: "Марки в каталога",
    popular: "Популярни продукти",
    viewAll: "Вижте всички",
    whyUs: "Защо да изберете нас",
    ctaTitle: "Нуждаете се от помощ при избора?",
    ctaSubtitle: "Обадете се или оставете запитване — ще Ви помогнем да изберете климатик за стаята и бюджета Ви. Безплатно е.",
    ...
    servicesProfilaktikaDesc: "Годишна поддръжка преди сезона — почистваме филтрите, проверяваме фреона. Климатикът работи тихо и пести ток.",
    servicesCta: "Вижте цените",
  },
  en: {
    categories: "Categories",
    brands: "Brands in our catalogue",
    popular: "Popular Products",
    viewAll: "View all",
    whyUs: "Why choose us",
    ctaTitle: "Need help choosing?",
    ctaSubtitle: "Call us or send an inquiry — we'll help you pick an AC that fits your room and budget. Free, no commitment.",
    ...
    servicesProfilaktikaDesc: "Yearly tune-up before the season — clean filters, freon check. Quieter operation, lower bills.",
    servicesCta: "See prices",
  },
  ru: {
    categories: "Категории",
    brands: "Бренды в каталоге",
    popular: "Популярные продукты",
    viewAll: "Смотреть все",
    whyUs: "Почему выбирают нас",
    ctaTitle: "Нужна помощь с выбором?",
    ctaSubtitle: "Позвоните или оставьте заявку — поможем выбрать кондиционер под вашу комнату и бюджет. Бесплатно.",
    ...
    servicesProfilaktikaDesc: "Годовая профилактика перед сезоном — чистим фильтры, проверяем фреон. Кондиционер работает тише и меньше тратит.",
    servicesCta: "Смотреть цены",
  },
  ua: {
    categories: "Категорії",
    brands: "Бренди в каталозі",
    popular: "Популярні продукти",
    viewAll: "Дивитись всі",
    whyUs: "Чому обирають нас",
    ctaTitle: "Потрібна допомога з вибором?",
    ctaSubtitle: "Зателефонуйте або залиште заявку — допоможемо обрати кондиціонер під вашу кімнату й бюджет. Безкоштовно.",
    ...
    servicesProfilaktikaDesc: "Річна профілактика перед сезоном — чистимо фільтри, перевіряємо фреон. Кондиціонер працює тихіше й менше витрачає.",
