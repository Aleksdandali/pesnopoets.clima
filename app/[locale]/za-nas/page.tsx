...
const content: Record<string, { title: string; subtitle: string; values: Array<{ title: string; desc: string }> }> = {
  bg: {
    title: "За нас",
...
export default async function AboutPage({ params }: { params: Promise<{ locale: string }> }) {
  ...
  return (
    <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
      ...
      <p className="text-lg text-muted-foreground leading-relaxed mb-12">{c.subtitle}</p>
