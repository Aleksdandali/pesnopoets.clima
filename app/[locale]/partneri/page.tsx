...
const COPY: Record<Locale, PageCopy> = {
  bg: {
    ...
    subtitle:
      "Търсим дългосрочни партньори във Варна: прораби, риелтори, дизайнери на интериор, домоуправители, строителни фирми. Препоръчвате ни клиент — ние доставяме, монтираме и обслужваме. Вие получавате 10% от крайната сума.",
    ctaPrimary: "Заявка за партньорство",
    ctaSecondary: "Видео разговор преди да започнем",
    highlights: [
    ...
    audience: [
      {
        label: "Прораби и строителни фирми",
        desc: "Обектът ви е готов — ние идваме с климатиците, монтираме и затваряме една точка от чеклиста ви.",
      },
      {
        label: "Риелтори и брокери",
        desc: "След сделката купувачите често питат откъде да си купят климатик. Вашата препоръка се превръща в реални 10%.",
      },
      {
        label: "Дизайнери на интериор",
        desc: "Скрит монтаж, канален климатик, мулти-сплит — предоставяме спецификации и каталог, без да натоварваме клиента.",
      },
      {
        label: "Домоуправители",
        desc: "Цял вход се преоборудва с климатици веднъж на няколко години — повтарящ се бизнес: монтаж и годишна профилактика.",
      },
      {
        label: "Електро- и ВиК-майстори",
        desc: "Виждате клиента първи. Свържете ни — ние затваряме поръчката, вие получавате процента.",
      },
      {
        label: "Управители на офиси и хотели",
        desc: "Голям обем — по-добри условия и индивидуален график на плащане.",
      },
    ],

    howTitle: "Как работи — 3 стъпки",
    howSubtitle: "Без договори от 20 страници и без бюрокрация.",
    steps: [
      {
    ...
    why: [
      ...
      },
      {
        ...
        desc: "Без „допълнително уточняване на място“. Калкулатор и писмена оферта преди монтажа — клиентът знае точно колко ще плати.",
      },
      {
    ...
    terms: [
      ...
      },
      {
        ...
        desc: "Колкото клиенти и да изпратите — всички се броят. Без седмични или месечни лимити.",
      },
      {
    ...
    faq: [
      ...
      {
        q: "Има ли минимум?",
        a: "Не. Дори една препоръка на тримесечие е добре дошла — комисионна се изплаща за всяка завършена поръчка.",
      },
      {
  ...
  en: {
    ...
    ctaSecondary: "Video call before we start",
    highlights: [
    ...
    audience: [
      ...
      },
      {
        ...
        desc: "An entire building cycles through new AC units every few years — recurring revenue: install plus annual service.",
      },
      {
    ...
    faq: [
      ...
      },
      {
        ...
        a: "No. Even one referral per quarter is welcome — commission is paid on every completed order.",
      },
      {
  ...
  ru: {
    ...
    ctaSecondary: "Видеозвонок-знакомство",
    highlights: [
    ...
    audience: [
      {
        ...
        desc: "Объект готов — мы приезжаем с кондиционерами, монтируем и закрываем один пункт вашего чек-листа.",
      },
      {
        label: "Риелторы и брокеры",
        desc: "После сделки покупатели часто спрашивают, где купить кондиционер. Ваша рекомендация — реальные 10%.",
      },
      {
        label: "Дизайнеры интерьера",
        desc: "Скрытый монтаж, канальный блок, мульти-сплит — предоставляем спецификации и каталог, не нагружая клиента.",
      },
      {
        label: "Домоуправители",
        desc: "Целый подъезд переоборудуется раз в несколько лет — повторный бизнес: монтаж и ежегодная профилактика.",
      },
      {
      ...
      },
      {
        ...
        desc: "Большой объём — лучшие условия и индивидуальный график выплат.",
      },
    ],
    ...
    earnings: [
      ...
      { job: "Мульти-сплит на 3 комнаты + дополнения", total: "€2 800", payout: "€280" },
    ...
    terms: [
      {
        ...
        desc: "Рассчитывается от фактически оплаченной клиентом суммы (кондиционер + монтаж + дополнения). НДС уже включён.",
      },
      {
    ...
    faq: [
      ...
      {
        q: "Есть ли минимум?",
        a: "Нет. Даже одна рекомендация в квартал — это уже хорошо. Комиссия выплачивается за каждый завершённый заказ.",
      },
      {
  ...
  ua: {
    ...
    subtitle:
      "Шукаємо довгострокових партнерів у Варні: прорабів, ріелторів, дизайнерів інтер'єру, управителів будинків, будівельні фірми. Ви приводите клієнта — ми постачаємо, монтуємо й обслуговуємо. Ви отримуєте 10% від підсумкової суми.",
    ctaPrimary: "Заявка на партнерство",
    ctaSecondary: "Відеодзвінок-знайомство",
    highlights: [
    ...
    audience: [
      {
        label: "Прораби та будівельні фірми",
        desc: "Об'єкт готовий — ми приїжджаємо з кондиціонерами, монтуємо й закриваємо один пункт вашого чек-листа.",
      },
      {
        label: "Ріелтори та брокери",
        desc: "Після угоди покупці часто запитують, де купити кондиціонер. Ваша рекомендація — реальні 10%.",
      },
      {
        label: "Дизайнери інтер'єру",
        desc: "Прихований монтаж, канальний блок, мульти-спліт — надаємо специфікації та каталог, не навантажуючи клієнта.",
      },
      {
        label: "Управителі будинків",
        desc: "Цілий під'їзд переоснащується раз на кілька років — повторний бізнес: монтаж і щорічна профілактика.",
      },
      {
      ...
      },
      {
        ...
        desc: "Великий обсяг — кращі умови та індивідуальний графік виплат.",
      },
    ],
    ...
    earnings: [
      ...
      { job: "Мульти-спліт на 3 кімнати + додатки", total: "€2 800", payout: "€280" },
    ...
    terms: [
      {
        ...
        desc: "Розраховується від фактично сплаченої клієнтом суми (кондиціонер + монтаж + додатки). ПДВ уже включений.",
      },
      {
    ...
    faq: [
      ...
      {
        q: "Чи є мінімум?",
        a: "Ні. Навіть одна рекомендація на квартал — це вже добре. Комісія виплачується за кожне завершене замовлення.",
      },
      {
