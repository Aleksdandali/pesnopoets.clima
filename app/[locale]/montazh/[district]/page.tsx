  ...
  switch (locale) {
    ...
    case "ru":
      return [
        ...
        { q: `Сколько стоит монтаж в ${districtName}?`, a: `Стандартный монтаж — от 190 € для уреда до 14 000 BTU и от 230 € до 24 000 BTU. Цена включает 3 м трассы, материалы, вакуумирование и пусконаладку. Без доплат за ${districtName} — тариф такой же, как везде по Варне.` },
...
function tr(locale: Locale, key: string): string {
  const map: Record<string, Record<Locale, string>> = {
    ...
    seeCatalog: { bg: "Виж каталога с климатици", en: "Browse AC catalogue", ru: "Каталог кондиционеров", ua: "Каталог кондиціонерів" },
